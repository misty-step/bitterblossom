...
flowchart LR
    ...
    Run --> Verify["verify work + PR state"]
...
flowchart LR
    ...
    Persona --> Prompt["upload prompt template"]
    Prompt --> Git["configure git auth"]
...
sequenceDiagram
    ...
    BB->>S: exec agent command
    S-->>BB: completion signal or artifact
