...
bb mcp serve                                      # read-only MCP stdio server (bb_status, bb_check, bb_tasks, bb_runs_list, bb_runs_show, bb_dlq_list, bb_preflight, bb_gate); JSON-RPC over stdin/stdout
```
