...
- Issue: [#484](https://github.com/misty-step/bitterblossom/issues/484) `[P1] Governance: do not merge while trusted external reviews are still pending`
- PR: [#489](https://github.com/misty-step/bitterblossom/pull/489) `feat: withhold merge while trusted external review surfaces are pending`
...
| Time | Event | Notes |
|------|-------|-------|
| 2026-03-06 18:42:53 -0600 | audit start | chose [#484](https://github.com/misty-step/bitterblossom/issues/484); existing builder pool was stale/dirty |
...
| 2026-03-06 18:49:28 -0600 | PR opened | [#489](https://github.com/misty-step/bitterblossom/pull/489) existed before run ledger surfaced it |
...
- Severity: P2
- Existing issue or new issue: [#490](https://github.com/misty-step/bitterblossom/issues/490)
...
- Severity: P2
- Existing issue or new issue: existing issue [#98](https://github.com/misty-step/bitterblossom/issues/98)
- Observed: the run stayed flat at `lease_acquired` + `builder_selected` for minutes. PR [#489](https://github.com/misty-step/bitterblossom/pull/489) existed and CI had started before `builder_complete` appeared in the run ledger.
...
- Evidence: [#489](https://github.com/misty-step/bitterblossom/pull/489) existed while `show-runs` still reported `phase=building`.

### Finding: builder edited on `master` before the run branch became visible

- Severity: P1
- Existing issue or new issue: existing issue [#469](https://github.com/misty-step/bitterblossom/issues/469)
- Observed: the fresh builder sprite showed dirty edits on `master` while implementing [#484](https://github.com/misty-step/bitterblossom/issues/484), even though the builder artifact later claimed branch `factory/484-p1-governance-do-not-merge-while-1772844224`.
...
- Severity: P1
- Existing issue or new issue: existing issue [#480](https://github.com/misty-step/bitterblossom/issues/480)
...
- Why it matters: the system spent real work to open [#489](https://github.com/misty-step/bitterblossom/pull/489), then died on reviewer infrastructure.
...
- New issues:
  - [#490](https://github.com/misty-step/bitterblossom/issues/490) `Env: fail fast on unsupported Python interpreter resolution`
- Existing issues commented:
  - [#480](https://github.com/misty-step/bitterblossom/issues/480) worker pool / reviewer readiness
  - [#469](https://github.com/misty-step/bitterblossom/issues/469) per-run worktrees / branch isolation
  - [#98](https://github.com/misty-step/bitterblossom/issues/98) observability / run narrative
- Priority changes:
  - none yet, but [#480](https://github.com/misty-step/bitterblossom/issues/480) and [#469](https://github.com/misty-step/bitterblossom/issues/469) are now even more clearly on the critical path

## Reflection

- What Bitterblossom did well:
  - fresh builder provisioning worked quickly
  - builder implemented [#484](https://github.com/misty-step/bitterblossom/issues/484), opened [#489](https://github.com/misty-step/bitterblossom/pull/489), and produced a correct artifact with tests
