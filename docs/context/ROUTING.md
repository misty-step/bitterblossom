...
- deleted legacy shell wrappers in historical docs as if they define the live control plane; current execution semantics live in `cmd/bb/*` and the conductor
...
| Change completion semantics | [`cmd/bb/dispatch.go`](../../cmd/bb/dispatch.go), [`docs/COMPLETION-PROTOCOL.md`](../COMPLETION-PROTOCOL.md), conductor artifact parsing |
