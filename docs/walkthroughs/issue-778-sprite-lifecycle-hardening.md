...
- `conductor/test/conductor/sprite_health_test.exs` proves cold sprites get the long probe timeout and warm sprites keep the fast path.
- `conductor/test/conductor/fleet/health_monitor_test.exs` proves periodic GC fires on the expected cadence for healthy sprites.
