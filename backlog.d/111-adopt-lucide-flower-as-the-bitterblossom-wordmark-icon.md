# Adopt Lucide flower as the bitterblossom wordmark icon

Priority: P2 · Status: open · Estimate: S

## Goal

Adopt the Lucide `flower` icon as the canonical wordmark/logo for
bitterblossom — Sprites infra — MTG enchantment that creates tokens every turn.
...
- [ ] The `flower` Lucide icon is rendered in the repo's primary
...
- Lucide icon: https://lucide.dev/icons/flower
