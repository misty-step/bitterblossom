# Simplification gate fixture

This task is the canonical simplification gate member. Variant tasks are not
canonical gate members and must use distinct verdict names.
